...
the three helper functions, isWordGuessed, getGuessedWord, and getAvailableLetters, that you've defined in the previous part.
    ...
    * After each round, you should also display to the user the 
    ...
    def hangman(secretWord):
        ...
        while guessesLeft > 0 and not isWordGuessed(secretWord, lettersGuessed):
            ...
            if userGuess not in getAvailableLetters(lettersGuessed):
